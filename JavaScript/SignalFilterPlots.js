let plotExpDecImpResp = function(p) {
  ...
  p.setup = function() {
    ...
    var correction = -100;
    // for some weird reason, the setDim function of GPlot makes the plots 100 pixels too wide and 
    // high, so we need this correction -> figure out, what's wrong with grafica here
    ...
    plot.setDim([width-margin+correction, height-margin+correction]); 
